...
func main() {
	auth := NewLoginAuth("sendhanee@outlook.com", "FAfafayoujian123")

	to := []string{"worldelitecao@foxmail.com"}
	msg := []byte("这是一封来自go的测试邮件")
	err := SendMail("smtp.office365.com:587", auth, "sendhanee@outlook.com", to, msg)
	if err != nil {
