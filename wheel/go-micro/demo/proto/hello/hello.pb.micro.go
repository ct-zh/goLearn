...
func (c *helloService) SayHello(ctx context.Context, in *SayRequest, opts ...client.CallOption) (*SayResponse, error) {
...
func (h *helloHandler) SayHello(ctx context.Context, in *SayRequest, out *SayResponse) error {
