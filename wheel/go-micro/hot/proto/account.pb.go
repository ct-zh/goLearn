...
type AccountResponse struct {
	...
	Account      string `protobuf:"bytes,1,opt,name=account,proto3" json:"account,omitempty"`
	ClientType   Type   `protobuf:"varint,2,opt,name=client_type,json=clientType,proto3,enum=account.Type" json:"client_type,omitempty"`
...
func (x *AccountResponse) GetClientType() Type {
	if x != nil {
		return x.ClientType
	}
	return Type_Wx
...
func (x *AccountResponse) GetSecurityCode() string {
	if x != nil {
...
func (x *AccountResponse) GetCreateTime() string {
	if x != nil {
		return x.CreateTime
	}
	return ""
...
type AccountTypeRequest struct {
	...
	Type    Type   `protobuf:"varint,1,opt,name=type,proto3,enum=account.Type" json:"type,omitempty"`
...
func (x *AccountTypeRequest) GetType() Type {
	if x != nil {
		return x.Type
	}
	return Type_Wx
...
func (x *AccountTypeRequest) GetAccount() string {
	if x != nil {
		return x.Account
	}
	return ""
...
func (x *AccountTypeResponse) GetIsSuccess() bool {
	if x != nil {
		return x.IsSuccess
	}
	return false
...
var file_proto_account_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x2a,
	...
	0x09, 0x52, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xa1, 0x01, 0x0a, 0x0f, 0x41,
	...
	,
	...
	0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x54, 0x79, 0x70,
	...
	0x74, 0x22, 0x34, 0x0a, 0x13, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65,
	...
	0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x2a, 0x17, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12,
	0x06, 0x0a, 0x02, 0x57, 0x78, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x41, 0x70, 0x70, 0x10, 0x01,
	0x32, 0x9f, 0x01, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x45, 0x0a, 0x0e,
	0x47, 0x65, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x17,
	...
	0x65, 0x22, 0x00, 0x12, 0x4d, 0x0a, 0x0e, 0x53, 0x65, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1b, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e,
	0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x41, 0x63, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x00, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x2f, 0x3b, 0x68, 0x6f, 0x74, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_proto_account_proto_goTypes = []interface{}{
	(Type)(0),                   // 0: account.Type
	(*AccountRequest)(nil),      // 1: account.AccountRequest
	(*AccountResponse)(nil),     // 2: account.AccountResponse
	(*AccountTypeRequest)(nil),  // 3: account.AccountTypeRequest
	(*AccountTypeResponse)(nil), // 4: account.AccountTypeResponse
}
var file_proto_account_proto_depIdxs = []int32{
	0, // 0: account.AccountResponse.client_type:type_name -> account.Type
	0, // 1: account.AccountTypeRequest.type:type_name -> account.Type
	1, // 2: account.Account.GetAccountInfo:input_type -> account.AccountRequest
	3, // 3: account.Account.SetAccountType:input_type -> account.AccountTypeRequest
	2, // 4: account.Account.GetAccountInfo:output_type -> account.AccountResponse
	4, // 5: account.Account.SetAccountType:output_type -> account.AccountTypeResponse
